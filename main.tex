...
\begin{frame}{ScaROOT}
\framesubtitle{Scala ROOT, not Scary ROOT!}

Started test implementation in the DIANA-HEP GitHub site.
...
\vspace{0.2 cm}
\begin{itemize}
\item Tried JNI (unsuccessfully) and JNA (successfully).
...
User doesn't need to know about {\tt scaroot.so}, but {\tt LD\_LIBRARY\_PATH} must point to ROOT shared objects.
\end{itemize}
