...
\item Community recommends {\tt try-finally} to avoid memory leaks more often than {\tt finalize()}.
\end{itemize}
...
Dynamically links Java code to pre-built shared libraries ({\tt .so} files).
\begin{itemize}
