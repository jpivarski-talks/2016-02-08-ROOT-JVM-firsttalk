...
\begin{block}{}
Pure-Java reimplementation of ROOT I/O on \url{java.freehep.org}
\begin{itemize}
\item Old: JAR file in user-facing documentation was compiled in 2001.
\item Hard to find: I had been under the impression that it was gone.
\item But it exists! I found it in \url{svn://svn.freehep.org/svn/freehep/trunk} (haven't tested yet).
\item Uses Java reflection to create runtime objects for structures in ROOT files.
\end{itemize}
\end{block}
