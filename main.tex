...
\begin{itemize}
\item Hard to find: I thought it was gone. (Documentation has only a JAR compiled in 2001.)
\item But it lives! \url{svn://svn.freehep.org/svn/freehep/trunk} has commits as recent as Oct 2015 (last {\tt src/main} commit May 2014).
